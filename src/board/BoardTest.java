...
public class BoardTest {
    ...
    public void testGetFieldMessage() {
        ...
        assertEquals("You -100 in a crater.", myTestBoard2.getFieldMessage("Palace gates"));
        assertEquals("You picked up a +100 note on the ground in Palace Gates.", myTestBoard2.getFieldMessage("Cold Desert"));
        assertEquals("You bought a thermal jacket, and -20 have been withdrawn from your balance.", myTestBoard2.getFieldMessage("Walled city"));
        assertEquals("You received your salary of +180, from your work at Walled City.", myTestBoard2.getFieldMessage("Monastery"));
        assertEquals("You are living your life as a monk/nun, your balance remains the same.", myTestBoard2.getFieldMessage("Black cave"));
        ...
        assertEquals("You just entered The Werewall! You have to throw the dice again to escape, cost -80." +
                "pris -80", myTestBoard2.getFieldMessage("The Werewall (werewolf-wall)"));
